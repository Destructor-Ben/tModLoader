...
public static class UICommon
{
	...
	internal static void LoadTextures()
	{
		...
		//ButtonConfigTexture = LoadEmbeddedTexture("UI.ButtonConfig");
		ButtonPlusTexture = LoadEmbeddedTexture("UI.ButtonPlus");
		ButtonUpDownTexture = LoadEmbeddedTexture("UI.ButtonUpDown");
		ButtonCollapsedTexture = LoadEmbeddedTexture("UI.ButtonCollapsed");
		ButtonExpandedTexture = LoadEmbeddedTexture("UI.ButtonExpanded");
